...
* [balena](#balena) : <code>object</code>
    ...
    * [.models](#balena.models) : <code>object</code>
        ...
        * [.release](#balena.models.release) : <code>object</code>
            ...
            * [.setNote(commitOrId, noteOrNull)](#balena.models.release.setNote) ⇒ <code>Promise</code>
...
##### ~~application.generateApiKey(slugOrUuidOrId) ⇒ <code>Promise</code>~~
***Deprecated***
...
##### device.pinToRelease(uuidOrIdOrIds, fullReleaseHashOrId) ⇒ <code>Promise</code>
...
##### release.setNote(commitOrId, noteOrNull) ⇒ <code>Promise</code>
**Kind**: static method of [<code>release</code>](#balena.models.release)  
